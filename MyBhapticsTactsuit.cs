...
namespace MyBhapticsTactsuit
{
    public class TactsuitVR
    {
        ...
        public TactsuitVR()
        {
            ...
            //var config = System.Text.Encoding.UTF8.GetString(ArkenAge_bhaptics.Properties.Resource1.config);

            //var res = BhapticsSDK2.Initialize("6902702f7c2f71a0f9dc2b58", "7q82BjAN9fk4wnXjGr8O", config);
